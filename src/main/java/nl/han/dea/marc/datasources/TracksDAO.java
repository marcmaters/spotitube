...
public class TracksDAO {
    ...
    public List<TrackDTO> getTracks(int playlistId) throws SQLException {
        ...
        getTracksFromDb(tracksInPlaylist, rsTracksInPlaylist);
        return tracksInPlaylist;
    }

    private void getTracksFromDb(List<TrackDTO> tracksInPlaylist, ResultSet rsTracksInPlaylist) throws SQLException {
